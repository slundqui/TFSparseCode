    ...
    def buildModel(self, inputShape):
        ...
        with tf.device(self.device):
            ...
            with tf.name_scope("LCA"):
                self.V1_U = uniform_weight_variable(self.VShape, "V1_U", 0, self.thresh+.01)
            ...
            with tf.name_scope("Opt"):
                ...
                #Find gradient wrt A
                self.lossGrad = self.learningRateA * tf.gradients(self.loss, [self.V1_A])[0]
                #TODO add momentum or ADAM here
                self.optimizerA = self.V1_U.assign(self.V1_U - self.lossGrad)
